...
Antes de mais nada, precisamos [criar a base de dados](http://devfuria.com.br/sql/mysql-criando-base-de-dados/).
...
Eu retirei o exemplo do [manual do MySQL](http://dev.mysql.com/doc/refman/5.7/en/creating-tables.html): imagine que precisamos construir um sistema para um PetShop. Talvez você queira registrar os nome dos bichanos e seus respectivos donos.
...
Poderemos fazer isso de registro em registro com a instrução **insert into** ou podemos fazer em uma “tacada só” [populando tabela a partir de uma arquivo de texto no MySQL](http://devfuria.com.br/sql/populando-tabela-a-partir-de-um-arquivo-de-texto-no-mysql/).
